...
d_short <- dat_upd %>% 
  select(keyid, title_cln, firstyear, lastyear, date, language, country)
...
d_timeline <- d_short %>%  
  ...
  mutate(start = as.character(start),
         ...
         tooltip = paste0(title, "<br>From <b>", start, "</b> to <b>", end, 
                          "</b><br>issued in <b>", country, "</b> in <b>", language, "</b> language</br>"))
