...
This blog post explores languages inside the "Russian" part of DIGAR Collection. The metadata for newspapers issued before 1918 shows large number of Russian-language newspapers, however the page-level data provides an evidence that many of the pages either not monolingual or not in Cyrillic at all. The analysis provided aims to show how the history of Russification in Estonia is reflected in digitized newspaper pages and how metadata issues may probably influence OCR quality.
...
glimpse(dat %>% 
          select(PageID, PageOCRAccuracy, date.x, year.x, DocumentTitle, language, country) %>% 
          sample_n(10))
